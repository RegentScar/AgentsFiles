...
Open the description with a simple explanation of the probllem based on the user's original prompt, then briefly explain the solution. Do not lead with an implementation inventory:
